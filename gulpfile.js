...
let path = {
	...
	src: {
		...
		video: [src_folder + "/video/**/*.{mp4,webm}"],
...
let buildDev = gulp.series(clean, gulp.parallel(fontsBuild, copyFolders, json, html, css, js, favicon, images, video));
